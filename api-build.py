...
async def get_report(
    ...
    category: str = Query("Quarterly", description="Category or time period"),
    with_summary: bool = Query(False, description="Include AI summary"),
    ...
    """
    try:
        # Run analysis with normalized parameters
        ...
        # Catch validation errors from analyzer
